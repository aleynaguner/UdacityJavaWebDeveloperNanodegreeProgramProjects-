...
public class PetController {
    ...
    public PetDTO savePet(@RequestBody PetDTO petDTO) {
        Pet pet = new Pet(petDTO.getName(), petDTO.getType(), petDTO.getBirthDate(), petDTO.getNotes());
    ...
    public List<PetDTO> getPetsByOwner(@PathVariable long ownerId) {
       return petService.getAllPetsByCustomerId(ownerId).stream().map(this::convertPetToPetDTO).collect(Collectors.toList());
    }
}
